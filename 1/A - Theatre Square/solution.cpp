...
 
SIMPLE OBSERVATIONS
the maximum squares of side a that can be placed in side n is n/a
similarly the maximum squares of side a that can be placed in side m is m/a
combined area = m*n, then the maximum squares  = n/a * m/a
 
--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------*/
void solve(){
    i64 n,m,a;
    cin>>n>>m>>a;
    i64 ans = ((m+a-1)/a)*((n+a-1)/a);
    cout<<ans<<endl;
}
